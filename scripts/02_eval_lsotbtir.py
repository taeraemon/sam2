...
# 실험 이름과 모델 이름
exp_name = "sam2.1_TIR" # 결과 저장 폴더명을 구분하기 위해 TIR 추가
model_name = "tiny"
# model_name = "small"
...
# ==================== 메인 추론 루프 ====================
# 체크포인트 및 설정 파일
checkpoint = f"checkpoints/sam2.1_hiera_{model_name}.pt"
model_cfg = (
    "configs/sam2.1/sam2.1_hiera_b+.yaml"
    if model_name == "base_plus"
    else f"configs/sam2.1/sam2.1_hiera_{model_name[0]}.yaml"
)
